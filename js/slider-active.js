(function ($) {
	...
	////text-slider
	var tp_brand_slide = new Swiper(".vebnox-text-slide-active", {
		loop: true,
		freemode: true,
		slidesPerView: 'auto',
		spaceBetween: 30,
	...
	////brand-slider
	var tp_brand_slide = new Swiper(".vebnox-brand-active", {
		loop: true,
		freemode: true,
		slidesPerView: 'auto',
		spaceBetween: 30,
	...
	////testimonial-slider
	var testimonial_2 = new Swiper('.vebnox-testimonial-slider-active', {
		slidesPerView: 6,
		loop: true,
		autoplay: false,
		arrow: false,
	...
	////team-slider
	var team = new Swiper('.vebnox-team-slider-active', {
		slidesPerView: 5,
		loop: true,
		autoplay: false,
		arrow: false,
	...
	////career-slider
	var career = new Swiper('.vebnox-career-slider-active', {
		slidesPerView: 5,
		loop: true,
		autoplay: false,
		arrow: false,
	...
	////service-4-slider
	var service = new Swiper('.vebnox-service-4-solution-active', {
		slidesPerView: 3,
		loop: true,
		autoplay: false,
		arrow: false,
	...
	//portfolio-slider
	var showcase = new Swiper('.vebnox-pd-2-active', {
		slidesPerView: 3,
		loop: true,
		autoplay: false,
		arrow: false,
	...
	//portfolio-slider
	var showcase = new Swiper('.vebnox-pd-4-slider-active', {
		slidesPerView: 3,
		loop: true,
		autoplay: false,
		arrow: false,
	...
	//portfolio-slider
	var showcase = new Swiper('.vebnox-pd-5-light-active', {
		slidesPerView: 5,
		loop: true,
		autoplay: true,
		arrow: false,
	...
	$(document).ready(function () {
	  $('.vebnox-pd-6-hero-slider-active').on('init', function (event, slick) {
	  ...
	  $('.vebnox-pd-6-hero-slider-active').on('wheel', function (e) {
		e.preventDefault();
    ...
    //------parallax-slider-----//
	var parallax_slider = new Swiper(".vebnox-showcase-slider-active", {
	  speed: 1500,
	  autoplay: {
		delay: 5000,
	  },
	  ...
	  on: {
		init: function () {
		  ...
		  for (var i = 0; i < swiper.slides.length; i++) {
			$(swiper.slides[i])
			.find('.vebnox-showcase-slider-bg')
	  ...
	  pagination: {
		el: '.vebnox-showcase-slider-main .swiper-pagination',
		clickable: true,
    ...
    //----text-slider------//
	var text_slider_option = document.querySelector(".vebnox-text-slider-4-active");
	if (text_slider_option) {
		...
		if (text_slider_autoplay == 'true') {
			var text_slider = new Swiper(".vebnox-text-slider-4-active", {
				loop: loop_value,
	...
	/////////////////////////////
	// shop slider
	var slider = new Swiper('.vebnox-hero-shop-2-active', {
		slidesPerView: 1,
		effect: 'fade',
		loop: true,
		// autoplay: {
		...
		// Navigation arrows
		pagination: {
			el: ".vebnox-hero-shop-dot",
			clickable: true,
		},
		navigation: {
			prevEl: '.vebnox-hero-shop-prev',
			nextEl: '.vebnox-hero-shop-next',
		},
	});

	////portfolio-slider
	$('.vebnox-portfolio-11-slider-active').slick({
		slidesToShow: 1,
		slidesToScroll: 1,
		...
		arrows: true,
		fade: false,
		asNavFor: '.vebnox-portfolio-11-slider-nav-active',
		fade: true,
		speed: 1000,
	});
	...
	function sliderInit() {
		var $slider = $('.vebnox-portfolio-11-slider-nav-active');
		$slider.each(function () {
			var $sliderParent = $(this).parent();
			$(this).slick({
				slidesToShow: 4,
				slidesToScroll: 1,
				asNavFor: '.vebnox-portfolio-11-slider-active',
				arrows: true,
				prevArrow: '<button type="button" class="slick-prev"><i class="fa-light fa-angle-left"></i></button>',
				nextArrow: '<button type="button" class="slick-next"><i class="fa-light fa-angle-right"></i></button>',
				dots: false,
			...
			if ($(this).find('.vebnox-portfolio-11-slider-nav-item').length > 1) {
